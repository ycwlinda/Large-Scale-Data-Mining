...
#knnprecision=precision_t
#knnrecall=recall_t
plt.plot(knnrecall,knnprecision,lw=2.5,label='KNN')
plt.plot(NMFrecall,NMFprecision,lw=2.5,label='NMF')
plt.plot(SVDrecall,SVDprecision,lw=2.5,label='SVD')
